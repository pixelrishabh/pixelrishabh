...
> ⚠️ This image only renders once the "snake" GitHub Action is set up on the `pixelrishabh/pixelrishabh` repo (it generates the `output` branch and SVG automatically). See setup notes below.
